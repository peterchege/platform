                ...
                <div class="row">
                    <div class="col-10 job-box">
                        <div class="job-description text-center">
                            ...
                            <br>
                            <form class="text-left" id="uploadForm" action="upload.php" method="post">
                                <div>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="user_file[]" type="file" class="form-control-file"
                                    ...
                                    <div class="row">
                                        <div class="col-6 text-left new-bt">
                                           ...
                                           <input type="submit" value="Attach" class="btn btn-block btn-primary" />
                                        </div>
                                        <P><br>
