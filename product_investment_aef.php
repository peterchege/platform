...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 asset-1a">
        </div>
    </div>
                                ...
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <p2><i>The price of shares, and the income therefrom is the collective
                                                ...
                                                circumstances their right to redeem their shares
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="phone" type="tel" class="form-control" id="inputAddress2" placeholder="Mobile Number" value="" data-parsley-pattern="^(?:254|\+254|0)?(7(?:(?:[129][0-9])|(?:0[0-8])|(4[0-1]))[0-9]{6})$" data-parsley-trigger="keyup">
                                </div>
                            </div>
