...
<head>
    ...
    <title>Anticipated Saving Plan | Akiba Halisi - APA Life</title>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <P class="text-justify">Akiba halisi has been designed to enable you to build a fund
                                    over a period of time and allows you to have access to this
                                    fund at specified times to enable you to meet your financial obligations. This plan
                                    also offers a life cover.
                                </P>
                                <P class="text-justify">The policy terms that you can choose are 6, 9, 12, 15 and 18
                                    years. Premium will be payable for the policy term selected or until
                                ...
                                <P class="text-justify">This policy has been designed to enable one to build a fund over
                                    a period of time and allow the policy holder to have
                                    access to his fund at specified times to enable him meet his obligations. It also
        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="row forms-download">
                ...
                <div class="col-md-3 box-download">
                    <a href=" pdf/brochure/APA Akiba Halisi.pdf" target="_blank">
                ...
                <!-- Claim Form -->
                <div class="col-md-3 box-download">
                    <a href="pdf/proposal/INDIVIDUAL LIFE SAVINGS.pdf" target="_blank">
                        <h2> <i class="fas fa-file-pdf"></i> Proposal</h2>
                        <hr>
                        <p>Akiba Halisi Form</p>
                        <hr>
                        <p class="download">Dowload <i class="fas fa-download"></i></p>
