...
<head>
    ...
    <title>Critical Illness Claim - APA Life</title>
                ...
                <div class="uk-padding-large">
                    ...
                    <form id="form-mp" action="<?=$_SERVER['PHP_SELF'];?>" method="POST" class="form-container form">
                        ...
                        <div style="display: none">
                            ...
                            <input type="hidden" id="claim_type" name="claim_type" value="critical illness">
                ...
                <div class="uk-padding-large">
                    ...
                    <form id="form-mp" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="form-container life-claim-form">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="claim_form_critical_illness">Attach document : Claim Form completed <a href="pdf/claim/Critical Ilness Claim form.pdf" target="_blank">(click here to download a claim form)</a></label>
