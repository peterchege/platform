...
<head>
    ...
    <title>Livestock Cover - APA Insurance</title>
    ...
    <div id="modal-close-outside" uk-modal>
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="row forms-download">
                ...
                <!-- Claim Form -->
                <!-- <div class="col-md-3 box-download">
                    <a href="pdf/claim/LIVESTOCK INSURANCE CLAIM FORM.pdf" target="_blank">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="phone" type="tel" class="form-control" id="phone" placeholder="0712345678" value="" data-parsley-pattern="^(?:254|\+254|0)?(7(?:(?:[123456789][0-9])|(?:0[0-8])|(4[0-1]))[0-9]{6})$" data-parsley-trigger="keyup" required>
                                </div>
                            </div>
