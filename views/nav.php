                                ...
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        ...
                                        <li><a href="product_commercial_bonds.php"><i class="fas fa-chart-area"></i>
                                                Bonds </a></li>
                                        <li><a href="product_commercial_engineer.php"><i class="fas fa-industry"></i>
                                                Engineering</a></li>
                                ...
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        ...
                                        <li><a href="product_commercial_theft.php"><i class="fas fa-user-secret"></i>
                                                Theft</a></li>
                                        <li><a href="product_commercial_wiba.php"><i class="fas fa-people-carry"></i>
                                                WIBA & Personal Accident</a></li>
                                    </ul>
                                </div>
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        ...
                                        <li><a href="product_commercial_micro.php"><i class="fas fa-hand-holding-usd"></i> Micro Insurance</a></li>
                                ...
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        <li><a href="product_investment_abf.php"><i class="fas fa-balance-scale"></i>
                                                Apollo Balanced Fund</a>
                                        </li>
                                        <li><a href="product_investment_aef.php"><i class="fas fa-chart-pie"></i> Apollo
                                                Equity Fund</a></li>
                                        <li><a href="product_investment_ammf.php"><i class="fas fa-chart-line"></i>
                                                Apollo Money Market Fund</a>
                                        </li><br>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="uk-navbar-dropdown-grid  uk-child-width-1-2 uk-visible@m" uk-grid>
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        ...
                                        <li><a href="apollo_centre_taita.php"><i class="fas fa-handshake"></i> Taita
                                                Hills
                                                (10-12px)</a></li>
                                        <li><a href="apollo_centre_ngong.php"><i class="fas fa-handshake"></i> Ngong
                                                Hills
                                                (8px)</a></li>
                                    </ul>
                                </div>
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        <li><a href="apollo_centre_chyullu.php"><i class="fas fa-hotel"></i> Chyullu
                                                ...
                                                Auditorium
                                                (40px)</a></li>
                                        <li><a href="apollo_centre_cherengani.php"><i class="fas fa-hotel"></i>
                                                Cherengani Hills -
                                                Training
                                                Room</a></li>
                    ...
                    <li class="list-down">
                        ...
                        <div class="uk-navbar-dropdown back-color" uk-drop="boundary: !nav; boundary-align: true; pos: bottom-justify;">
                            <div class="uk-navbar-dropdown-grid  uk-child-width-1-2 uk-visible@m" uk-grid>
                                ...
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        <li><a href="media_centre_video.php?page=1"><i class="fas fa-newspaper"></i> News &
                                                Updates</a></li>
                                        <li><a href="csr.php?page=1"><i class="fas fa-user-friends"></i> CSR</a></li>
                            ...
                            <div class="uk-navbar-dropdown-grid  uk-child-width-1-3 uk-visible@m" uk-grid>
                                ...
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                                        ...
                                        <li><a href="https://portal.apainsurance.org/TurnQuestAgent/faces/index.jspx?_afrWindowMode=0&_afrLoop=14884103847609303&_adf.ctrl-state=mbeaekind_9"><i class="fas fa-file-alt"></i> Life Intermediary Portal</a>
                                        </li>
                                        <li><a href="https://portal.apainsurance.org/TurnQuestClient/faces/index.jspx?_afrWindowMode=0&_afrLoop=14884103847609303&_adf.ctrl-state=mbeaekind_9"><i class="fas fa-file-alt"></i> Life Client Portal</a></li>
                                    </ul>
                                </div>
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi">
                            ...
                            <div class="uk-navbar-dropdown-grid  uk-child-width-1-3 text-center uk-visible@m" uk-grid>
                                ...
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav head-navi text-left">
                                        <li><a href="index.php"> <img src="img/kenya.png" class="rounded" width="30" height="auto" alt="APA KENYA"> &nbsp; KENYA</a></li>
                                        <li><a href="http://apainsuranceuganda.com/"> <img src="img/uganda.png" class="rounded" width="30" height="auto" alt="APA UGANDA"> &nbsp; UGANDA</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KQGRFJK" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
