        ...
        if (
            ...
            if (empty($_POST['property']) || !isset($_POST['property'])) {
                ...
                if ((empty($_POST['content']) && empty($_POST['building'])) || (!isset($_POST['content']) && !isset($_POST['building']))) {
                    ...
                    $building = ((isset($_POST['building'])) ? filter_var(mysqli_real_escape_string($db, $_POST['building']), FILTER_SANITIZE_NUMBER_INT, FILTER_FLAG_STRIP_HIGH) : null);;
                    $content = ((isset($_POST['content'])) ? filter_var(mysqli_real_escape_string($db, $_POST['content']), FILTER_SANITIZE_NUMBER_INT, FILTER_FLAG_STRIP_HIGH) : null);;
                    $allrisk = ((isset($_POST['allrisk'])) ? filter_var(mysqli_real_escape_string($db, $_POST['allrisk']), FILTER_SANITIZE_NUMBER_INT, FILTER_FLAG_STRIP_HIGH) : null);;
                    $domestic = ((isset($_POST['domestic'])) ? filter_var(mysqli_real_escape_string($db, $_POST['domestic']), FILTER_SANITIZE_NUMBER_INT, FILTER_FLAG_STRIP_HIGH) : null);;
                    $liability = ((isset($_POST['liability'])) ? filter_var(mysqli_real_escape_string($db, $_POST['liability']), FILTER_SANITIZE_NUMBER_INT, FILTER_FLAG_STRIP_HIGH) : null);;
                    ...
                    if ($result) {
                        ...
                        $response['message'] = 'An error occurred: ' . mysqli_erro($db);
                    }
                }
            }
        }
