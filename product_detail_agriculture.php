...
<body>
    ...
    <div class="container-fluid212">
        <div class=" header-image header-image3">
        </div>
    </div>
                        ...
                        <div class="text-justify">
                            ...
                            <ul>
                                <li>This cover compensates farmers for crop damage as a result of deficit or excesses in
                                    weather conditions such as temperature, sunlight, wind speed or rainfall resulting
                                    in
                                    losses during the length of the crop growth cycle up to physiological maturity.</li>
                            </ul><br>
                            <div class="row">
                                <div class="col-4">
