...
<head>
    ...
    <title>Morgage Protection - APA Life</title>
...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 life-8">
        </div>
    </div>
                                ...
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <P2 class="text-justify">This rider Compensates for
                                            ...
                                            period
                                            for
                                            disability benefit payment either 2 years, 5 years or up to normal
                                            retirement
                                            age.
                                        </p2><br>
                        ...
                        <div class="tab-pane fade" id="start" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="job-description text-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="load-more text-center">
                                            <a href="#" class="btn btn-danger" data-target="#modal-close-outside" uk-toggle="target: #modal-close-outside"> Download
                                                Form
                                            </a>
                                        </div>
                                    </div>
