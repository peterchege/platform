...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2019 at 08:09 AM
...
(1, '7sD7LDAkco1BOHlmP1q', 'Peter', 'Chege', 'p@gmail.com', 'p@gmail.com', '', '', '', '2019-05-03 18:38:02.969581', '96454'),
...
(5, '1306824732', 'Anthony Baru', '', '', '', 'http://pbs.twimg.com/profile_images/378800000779527007/feedf127f96e32bb11aadad1769c8872_normal.jpeg', 'twitter', '', '2019-05-03 18:38:02.969581', NULL),
...
(7, '101393073819430510008', 'Anthony Baru', '', 'anthonybaru@gmail.com', '$2y$10$fP0QvfMm2CMCJZa4y5UgveJoXn16DUhIpMMw.ZVvWHhH/3ZrtRxmS', 'https://lh5.googleusercontent.com/-HWPcBgCdDyw/AAAAAAAAAAI/AAAAAAAAArU/3y9lGdudDxU/photo.jpg', 'google', '', '2019-05-03 18:38:02.969581', 'gKXk3T9r1pXZtakbPgU'),
...
(13, '108937552463137459023', 'njoroge kangethu', '', 'kangethu2@gmail.com', '$2y$10$uFIm1vJnvuckhhCqOTwpN.llP3PM/VZZLYyMGslJCsBphSkTSZghi', 'https://lh3.googleusercontent.com/-xm7cl86Gw2k/AAAAAAAAAAI/AAAAAAAAAXM/wsaxC5cR4UM/photo.jpg', 'google', '', '2019-05-03 18:38:02.969581', 'bBnmYxmM2ndAiQRw8Kg9'),
(21, 'zeabRO5TFz', 'anthony baru', '', '', '', '', 'linkedin', '', '2019-05-03 19:05:52.788317', NULL),
(22, 'z-qjDjqLBW', 'peter chege', '', '', '', 'https://media.licdn.com/dms/image/C5603AQGqi94U3MJ-hQ/profile-displayphoto-shrink_100_100/0?e=1562198400&v=beta&t=Q5g8LU0vFKBoXJVWq7PpKtMAiNOeA-YGppeKBc7iU1U', 'linkedin', '', '2019-05-03 19:07:34.784561', NULL);
...
INSERT INTO `apa_job_applicants_employment_history` (`id`, `employer_company`, `position`, `start_date`, `end_date`, `current_job`, `salary`, `notice_period`, `roles_performed`, `applicant_id`, `job_id`) VALUES
(4, 'fhtfh', 'fhfhfh', '2016-10-28', '2017-10-29', 'Yes', '234567', '456666', 'hjthyfhjgjh', '', '');
...
(5, 'tony', 'tony', 'tony@gmail.com', 'abc7dc9687c643abead5603e23171c72'),
(7, 'chege', 'chege', 'chege@gmail.com', '775f677dc88a65fd5803c73aeda05c69'),
(8, 'gilbert', 'gilbert', 'gilbert@gmail.com', '43cfb263a8fcf1d0ac3685d979bf874d');

-- --------------------------------------------------------

--
-- Table structure for table `key_primary_responsibilities`
--

CREATE TABLE `key_primary_responsibilities` (
  `id` int(10) NOT NULL,
  `apa_insurance_careers_id` int(15) NOT NULL,
  `business_requirements_and_analysis` longtext NOT NULL,
  `data_visualization` longtext NOT NULL,
  `information_quality_assurance` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `key_primary_responsibilities`
--

INSERT INTO `key_primary_responsibilities` (`id`, `apa_insurance_careers_id`, `business_requirements_and_analysis`, `data_visualization`, `information_quality_assurance`) VALUES
(1, 1, 'Consulting with end users / Management on business needs, translating business needs into analytics/ reporting requirements\r\nInterprets business requirements and determines optimum BI solutions to meet business needs.\r\nAdvises executives on how BI (processes, practices and technologies) play a critical role in improving business management and optimization\r\nResearches business problems and creates models that help analyse these business problems.\r\nCollaborating with end users to identify needs and opportunities for improved data management and analysis.\r\nDeveloping, packaging and delivering new service offerings related to business intelligence, encompassing clearly defined value propositions and creating realistic profitability models', 'Develop and improve custom data visualization and analytics tools to help various teams within the group identify trends and best practices, and support in their monitoring of monthly and annual goals\r\nDevelop business intelligence reports – including interactive business intelligence reports, strategic management reports and ad hoc reports – on a prioritised basis\r\ncoordinating the ongoing development and operations of a business intelligence architecture that enables fact-based decision-making, ad hoc analysis and insight generation\r\nTo advise generally on the potential for data use across the business, and also to make colleagues aware of any opportunities presented by the datasets for cross selling.\r\nProviding regular analysis and interpretation of data and trends to support decision making by the management team, including text, graphics and other statistical representations\r\nCreation of dashboards for presentation of accurate information to Management at different levels and locations', 'Overseeing development of an enterprise data warehouse as part of Group wide digital transformation strategy\r\nImproving and streamlining processes regarding data flow and data quality to improve information confidentiality, integrity and availability'),
(2, 2, 'Consulting with end users / Management on business needs, translating business needs into analytics/ reporting requirements\r\nInterprets business requirements and determines optimum BI solutions to meet business needs.\r\nAdvises executives on how BI (processes, practices and technologies) play a critical role in improving business management and optimization\r\nResearches business problems and creates models that help analyse these business problems.\r\nCollaborating with end users to identify needs and opportunities for improved data management and analysis.\r\nDeveloping, packaging and delivering new service offerings related to business intelligence, encompassing clearly defined value propositions and creating realistic profitability models', 'Develop and improve custom data visualization and analytics tools to help various teams within the group identify trends and best practices, and support in their monitoring of monthly and annual goals\r\nDevelop business intelligence reports – including interactive business intelligence reports, strategic management reports and ad hoc reports – on a prioritised basis\r\ncoordinating the ongoing development and operations of a business intelligence architecture that enables fact-based decision-making, ad hoc analysis and insight generation\r\nTo advise generally on the potential for data use across the business, and also to make colleagues aware of any opportunities presented by the datasets for cross selling.\r\nProviding regular analysis and interpretation of data and trends to support decision making by the management team, including text, graphics and other statistical representations\r\nCreation of dashboards for presentation of accurate information to Management at different levels and locations', 'A relevant qualification, e.g. finance, statistics, economics, business studies, information technology or equivalent expertise.\r\nRelevant professional qualification from a recognized institution.');
...
--
-- Indexes for table `key_primary_responsibilities`
--
ALTER TABLE `key_primary_responsibilities`
  ADD PRIMARY KEY (`id`),
  ADD KEY `apa_insurance_carreers_id` (`apa_insurance_careers_id`);
...
--
-- AUTO_INCREMENT for table `apa_job_applicants_certification`
--
ALTER TABLE `apa_job_applicants_certification`
...
--
-- AUTO_INCREMENT for table `key_primary_responsibilities`
--
ALTER TABLE `key_primary_responsibilities`
...
--
-- Constraints for table `key_primary_responsibilities`
--
ALTER TABLE `key_primary_responsibilities`
  ADD CONSTRAINT `job_description_fk` FOREIGN KEY (`apa_insurance_careers_id`) REFERENCES `apa_insurance_careers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
