        ...
        <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
            ...
            <div class="modal-cont">
                ...
                <p>The section caters for furniture, household goods, and personal effects of every description,
                    ...
                    fittings, the insured’s own or for which he is legally responsible, not being the landlord’s
    ...
    <div id="modal-center3" class="uk-flex-top" uk-modal>
        <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
            ...
            <div class="modal-cont">
                ...
                <hr>
                <p>This covers domestic servants such as house helps, watchmen, gardeners and drivers in respect of
                    injury,
                    death or disease arising out of and in the course of employment. The cover is mandatory for all
                    employers
    ...
    <div id="modal-center4" class="uk-flex-top" uk-modal>
        <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
            ...
            <div class="modal-cont">
                ...
                <hr>
                <p>This section covers liabilities as a result of death or injury to third parties and damage to third
                    party
