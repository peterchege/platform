        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="customer-login1">
                    ...
                    <form id="internship_form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="full_name" type="text" class="form-control" id="full_name"
                                        aria-describedby="" placeholder="e.g john" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="email" type="email" class="form-control" id="email" aria-describedby=""
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="date" type="text" class="form-control" id="date" aria-describedby=""
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6">
