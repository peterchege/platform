...
<head>
    ...
    <title>Group Life Claims - APA LIFE</title>
                ...
                <div class="row row-product">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="product-box we life-4">
                            <a href="claim_report_life_group_lastexpense.php">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="product-box we img-group ">
                            <a href="claim_report_life_group_lifebenefit.php" >
                                <div class="color-overlay"></div>
                                <div class="wrapper">
                                    <div class="content">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="product-box we img-critical">
                            <a href="claim_report_life_group_critical_illness.php">
                                <div class="color-overlay"></div>
                                <div class="wrapper">
                                    <div class="content">
                ...
                <div class="row row-product">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="product-box we img-ttd">
                            <a href="claim_report_life_group_occupational.php">
                                <div class="color-overlay"></div>
                                <div class="wrapper">
                                    <div class="content">
