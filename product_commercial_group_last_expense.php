...
<head>
    ...
    <title>Group Last Expense Cover - APA Life</title>
...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 com-20">
        </div>
    </div>
    ...
    <div id="modal-full" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-top" uk-grid>
                <div class="uk-background-cover uk-visible@m" style="background-image: url('img/group_last_expense.jpg'); background-size: cover;" uk-height-viewport></div>
