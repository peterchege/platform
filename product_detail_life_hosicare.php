...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 life-4">
        </div>
    </div>
        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="row forms-download">
                ...
                <div class="col-md-3 box-download">
                    <a href=" pdf/brochure/APA Hosi Care.pdf" target="_blank">
                ...
                <!-- Claim Form -->
                <div class="col-md-3 box-download">
                    <a href="pdf/claim/Hosicare- claim form.pdf" target="_blank">
                        <h2> <i class="fas fa-file-pdf"></i> Claim Form</h2>
                        <hr>
                        <p>Hosicare Claim form</p>
                        <hr>
                        <p class="download">Dowload <i class="fas fa-download"></i></p>
                    </a>
                </div>
