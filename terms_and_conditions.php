...
<body>
    ...
    <div class="container-fluid12">
        <div class="container apollo app-terms">
            ...
            <!-- Introduction -->
            <h2 class="wow fadeInUp" data-wow-delay="0.1s">Introduction </h2>

            <p class="text-justify content-offer wow fadeInUp" data-wow-delay="0.1s">
            ...
            <!-- Who We Are -->
            <h2 class="wow fadeInUp" data-wow-delay="0.1s"> Who We Are </h2>
            ...
            <h2 class="wow fadeInUp" data-wow-delay="0.1s"> The Data We Collect About You </h2>
            <p class="content-offer wow fadeInUp text-left" data-wow-delay="0.1s">
                We may collect, use, store and transfer different kinds of personal data about you which we have grouped together follows:
            </p>
            <ul class="text-justify">
                <li class="wow fadeInUp" data-wow-delay="0.1s"><b>Identity Data</b> includes first name, last name, title, date of birth, vehicle registration number and claim reference number.
                ...
                <li class="wow fadeInUp " data-wow-delay="0.1s"><b>Contact Data </b>includes email address, telephone numbers, address and postcode. </li><br>
                <li class="wow fadeInUp " data-wow-delay="0.1s"><b>Technical Data</b> includes internet protocol (IP) address, your login data, browser
