...
<head>
    ...
    <title>Femina cover | Cancer Care - APA Insurance</title>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <P class="text-justify">There are two common threats to women’s lives today – Breast
                                    Cancer and Cervical Cancer. In most
                                    cases, these two are rarely diagnosed
                                    in time and when they are, considerable damage/harm may be in the offing.
                                </P>
                                <p class="text-justify"> However, with proper management, one can lead a normal and
                                    stress-free life. It is a cash benefit
