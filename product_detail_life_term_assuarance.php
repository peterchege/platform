...
<head>
    ...
    <title>Life Cover | Term Assuarance - APA Life</title>
...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 life-6">
        </div>
    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <P class="text-justify">The minimum and maximum ages at entry are 18 years and 70 years
                                    respectively.
                                ...
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <p2>The premiums can be paid on a monthly, quarterly, semi-annually or annually
                                            and the modes
                                            of payment include Standing Order, Cheque, and Direct Debit Authority,
                                            M-Pesa or Salary Check off.
                                        </p2>
                                        <p> b) Policy Terms</p>
                                        <ol>
                            ...
                            <div class="job-description text-center">
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <p2>All future premiums will be waived following total permanent disability due
                                            to accident
                                            or illness.
                                        </p2>
                                        ...
                                        <p2> In the event of loss of employment due to adverse business conditions e.g.
                                            introduction of
        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="row forms-download">
                ...
                <div class="col-md-3 box-download">
                    <a href="pdf/brochure/APA Term Life.pdf" target="_blank">
                ...
                <!-- <div class="col-md-3 box-download">
                    <a href="pdf/proposal/INDIVIDUAL LIFE SAVINGS.pdf" target="_blank">
                        ...
                        <hr>
                        <p>Term Assuarance Claim form</p>
                        <hr>
