                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <P class="text-justify">The minimum and maximum ages at entry are 18 years and 70 years respectively.
                                ...
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <p2>The premiums can be paid on a monthly, quarterly, semi-annually or annually and the modes
                                            of payment include Standing Order, Cheque, and Direct Debit Authority, M-Pesa or Salary Check off.
                                        </p2>
                                        <p> b) Policy Terms</p>
                                        <ol>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="model" type="text" class="form-control" id="model" placeholder="( Minimum Ksh 5,000,000 )" value="" required>
                                </div>
                            </div>
                            <div class="row">
