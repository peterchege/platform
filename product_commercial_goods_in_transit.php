...
<head>
    ...
    <title>Goods in Transit Cover - APA Insurance</title>
...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 com-14">
        </div>
    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <h2>Good In Transit (GIT) </h2>
                                <P class="text-justify">Loss or damage to merchandise and goods incidental to the
                                    Insured's business the property of the Insured or held by the Insured
                                    in trust or on commission and for which the Insured is responsible while being
                                    carried by any conveyance described in the schedule hereto anywhere in
                                    Kenya the cover to apply from the time the said merchandise and goods are lifted by
                                    the Insured's employees until the said merchandise and goods are
                                    placed in position by them at their destination, including loading and unloading.
                                </P>
                                <br><br><br>
                                <div class="row">
                                    <div class="col-md-4">
                        ...
                        <div class="tab-pane fade" id="start" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="job-description text-left">
                                <br>
                                <p>If you are interested in learning how much GIT insurance would cost
                                    you, or if you are interested in purchasing GIT insurance, please click
                                    <b>Get Cover</b>.
                                </p>
                                <p>
                                    If you would like further explanation or assistance about GIT insurance and how it
                                    can help keep your business running,
                                    please click <b>I Need Assistance</b>.
                                </p>
                                <!-- <p>
                                    <b> Download forms</b> will give you access to any relevant documents for GIT
                                    insurance,
