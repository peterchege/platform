...
<head>
    ...
    <title>Companies | APollo Group -  APA Insurance</title>
...
<body>
    ...
    <div class="container-fluid12">
        <div class="container apollo">
            <h1 class="wow fadeInUp" data-wow-delay="0.1s">OUR COMPANIES</h1>
            <div class="under-line img7">
                <img src="images/line.png" alt="">
            </div>

            <p class="container content-offer wow fadeInUp" data-wow-delay="0.1s">
Apollo Group (Apollo Investments Limited) was an idea born from the need to harness synergies across the insurance business. Established in 1977 as one of the first locally owned insurance companies, Apollo has achieved impressive growth over the years thanks to unwavering commitment to service, the confidence of the policyholders and constant adherence to sound management policy.
            ...
            <div class="row">
                ...
                <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class=" charter-block">
                        ...
                        <hr>
                        <p>
                        Our products and services are well known and respected in the market. We have built our reputation through hard work and good service.
                        </p>
            ...
            <div class="row">
                <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="charter-block">
                        ...
                        <hr>
                        <p>
                           We tailor-make our products and services to provide capacity and protection to retail and corporate customers to enable them to manage their risks.
                        </p>
