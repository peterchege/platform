...
<head>
    ...
    <title>Credit Life Cover - APA Life</title>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <P class="text-justify">This is a life insurance policy designed to pay, for a borrower,
                                    the remaining principal balance, assuming the borrower
                                    had made all the due installments.</P>
                                <P class="text-justify">The policy applies in case of death, disability or even loss of
                                    employment of the borrower of a
                                ...
                                <div class="job-content text-justify">
                                    ...
                                    <div class="text-justify">
                                        <p> What are the benefits of Credit Life Insurance?.</p>
                    ...
                    <form id="form" action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" class="form-container">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="phone">Mobile Number</label>
                                    <input name="phone" type="tel" data-parsley-pattern="^(?:254|\+254|0)?(7(?:(?:[123456789][0-9])|(?:0[0-8])|(4[0-1]))[0-9]{6})$" data-parsley-trigger="keyup" class="form-control" id="phone" placeholder="07xx 232 xxx" value="" required>
                                </div>
                            </div>
