...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 com-18">
        </div>
    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="start" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="job-description text-left">
                                ...
                                <!-- <p>
                                    <b> Download forms</b> will give you access to any relevant documents for Micro
                                    Insurance products,
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input name="full_name" type="text" class="form-control"
                                                                    id="full_name" placeholder="john doe" value=""
                                                                    required>
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label for="phone">Mobile Number</label>
                                                                <input name="phone" type="tel" class="form-control"
                                                                    id="phone" placeholder="07xx 245 xxx" value=""
                                                                    data-parsley-pattern="^(?:254|\+254|0)?(7(?:(?:[129][0-9])|(?:0[0-8])|(4[0-1]))[0-9]{6})$"
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input name="email" type="email" class="form-control"
                                                                    id="email" placeholder="john@example.com" value=""
                                                            ...
                                                            <div class=" form-group col-md-12">
                                                                ...
                                                                <input name="location" type="text" class="form-control"
                                                                    id="location" placeholder="Nairobi" value=""
                                                                    required>
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                        ...
                                                        <div style="display: none">
                                                            ...
                                                            <input type="hidden" id="product_category_id"
                                                                name="product_category_id" value="14">
                                                        ...
                                                        <div class="row book-btn">
                                                            <div class="col-md-12">
                                                                <button type="submit" name="request"
                                                                    class="btn btn-primary"> REQUEST ASSISTANCE <i
