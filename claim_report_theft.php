...
<head>
    ...
    <title>Theft Claim -APA INSURANCE</title>
                ...
                <div class="uk-padding-large">
                    ...
                    <form id="motor-claim-upload" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="form-container  motor-claim-upload">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="claim_form_motor">Attach documents : <!-- Claim Form completed 
                                     <a href="pdf/claim/PROPERTY LOSS CLAIM FORM.pdf" target="_blank">(click here
                                            to download a claim form)</a> -->
                                            </label>
