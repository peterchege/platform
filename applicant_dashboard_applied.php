    ...
    <header id="header">
        <div class="container-fluid">
            ...
            <div id="logo" class="pull-left">
                ...
                <a href="index.html" id="im-left"><img src="img/logon.jpg" width="85" height="auto" alt=""
                        title="" /></a>
            </div>
        ...
        <div id="logo2" class="pull-right">
            <a href="#"><img class="img-crl" src="images/peterchege.png" width="60" height="auto" alt=""
                    title="" /></a>
        </div>
    </header><!-- #header -->
    ...
    <div class="row ">
        <div class="col-10 job-box">
            <div class="job-description text-center">
                <h2>BUSINESS INTELLIGENCE OFFICER</h2>
                <hr><br>
                ...
                <div class="row job-content">
                    <div class="col-8 text-justify">
                        <ul class="text-left">
                            ...
                            <li><b>REPORTS TO:</b> <span> Group Chief Information Officer</span> </li>
                    ...
                    <div class="col-4">
                        <div class="load-more text-center">
                            <a href="job_description.html" class="btn btn-career btn-danger">WITHDRAW</a>
                        </div>
                    </div>
                </div><BR>
            </div>
