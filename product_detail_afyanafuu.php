...
<head>
    ...
    <title>Afya Nafuu Cover | Medical Cover - APA Insurance</title>
        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="row forms-download">
                ...
                <div class="col-md-3 box-download">
                    <a href=" pdf/brochure/Afya Nafuu Brochure.pdf" target="_blank"">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select id="inpatient" name="inpatient" class="form-control selectFilter" data-target="section" required>
                                        ...
                                        <option name="" value="1000000">Kshs 1,000,000
                                        </option>
                                        <option name="" value="750000">Kshs 750,000
                                        </option>
                                        <option name="" value="500000">Kshs 500,000
                                        </option>
                                        <option name="" value="300000">Kshs 300,000
                                        </option>
                                        <option name="" value="100000">Kshs 100,000
                                        </option>
                                    </select>
                                </div>
                            </div>
