                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <p2>Our funeral expenses include, among other things, mortuary fees, the cost of
                                            ...
                                            <li>Minimize the financial impact of unexpected death on the surviving
                        ...
                        <div class="tab-pane fade" id="start" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="job-description text-left">
                                ...
                                <p>will give you access to any relevant documents for this insurance product, such as
                                    the claim form, proposal form, etc.<b>I Need Assistance.</b>
                                </p>
                                <p>
        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="row forms-download">
                ...
                <div class="col-md-3 box-download">
                    <a href=" pdf/brochure/APA Pumzisha.pdf" target="_blank">
                ...
                <!-- Claim Form -->
                <div class="col-md-3 box-download">
                    <a href="pdf/proposal/PUMZISHA & HOSICARE INDIVIDUAL LIFE RISK.pdf" target="_blank">
                ...
                <!-- Claim Form -->
                <div class="col-md-3 box-download">
                    <a href="pdf/claim/Pumzisha Claim form.pdf" target="_blank">
        ...
        <div class="uk-modal-dialog">
            ...
            <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-top" uk-grid>
                <div class="uk-background-cover"
                    style="background-image: url('img/funeral.jpg'); background-size: cover;" uk-height-viewport></div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="period" type="text" class="form-control" id="period" min="5" max="20"
