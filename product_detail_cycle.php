...
<head>
    ...
    <title>Cycle Cover - APA Insurance</title>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="phone" type="tel" class="form-control" id="phone" placeholder="07xx 214 xxx" value="" data-parsley-pattern="^(?:254|\+254|0)?(7(?:(?:[123456789][0-9])|(?:0[0-8])|(4[0-1]))[0-9]{6})$" data-parsley-trigger="keyup" required>
                                </div>
                            </div>
