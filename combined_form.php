...
<body>
    ...
    <div id="msform">
        ...
        <ul id="progressbar">
            <li class="active" id="active1">PERSONAL <br>INFORMATION</li>
            <li id="active2">EMPLOYMENT<br> HISTORY</li>
            <li id="active3">EDUCATION<br> BACKGROUND</li>
            <li id="active4">FILE <br>ATTACHMENT</li>
            <li id="active5">REVIEW <br>AND SUBMIT</li>
            <!-- <li ><br>SUMMARY</li> -->
        </ul>
                        ...
                        <div class="job-description text-center">
                            ...
                            <form class="text-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><span class="icon_star">&#10040;</span>Last
                                                Name</label>
                    ...
                    <div class="col-10 job-box">
                        <div class="job-description text-center">
                            ...
                            <div class="desc-cont text-left">
                                ...
                                <p>Please list your work experience below, starting with the most recient one</p>
                            </div>
        ...
        <fieldset id="third">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-10 job-box">
                        <div class="job-description text-center">
                            <h2>EDUCATION AND PROFESSIONAL<BR> QUALIFICATION</h2>
                            <div class="desc-cont text-left">
                                <h3>EDUCATION</h3>
                                <p>Please list your educational experiences below, starting with the most recent one.
                                </p>
                            </div>
        ...
        <fieldset id="fifth">
            ...
            <div class="col-md-4">
                <div class="text-center  new-bt">
                    <a href="#" class="btn btn-primary"><b>SUBMIT</b></a>
                </div>
            </div>
        </fieldset>
    </div>
