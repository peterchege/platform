...
<head>
    ...
    <title>Partial Life Maturity Claim -APA INSURANCE</title>
                ...
                <div class="uk-padding-large">
                    ...
                    <form id="form-mp" action="<?=$_SERVER['PHP_SELF'];?>" method="POST" class="form-container form">
                        ...
                        <div style="display: none">
                            ...
                            <input type="hidden" id="claim_type" name="claim_type" value="partial maturity">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input name="documents[]" type="file" class="form-control-file" id="policy_document_partial_maturity" required>
                                </div>
                            </div>
