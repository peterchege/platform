...
--
-- Table structure for table `customer_cover_information`
--

CREATE TABLE `customer_cover_information` (
  `id` int(11) NOT NULL,
  `customer_quotation_fk` int(11) NOT NULL,
  `property` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `building` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `contents` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `all_risk` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `domestic_employee` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `liability` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `customer_quotation` (`id`, `name`, `phone`, `email`, `location`) VALUES
(2, 'name', '24515', 'p@gmail.com', 'nai'),
(3, '', '', '', ''),
(4, 'name', '24515', 'p@gmail.com', 'nai'),
(5, 'name', '24515', 'p@gmail.com', 'nai'),
(6, '', '', '', ''),
(7, 'name', '24515', 'p@gmail.com', 'nai');
...
--
-- Indexes for table `customer_cover_information`
--
ALTER TABLE `customer_cover_information`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `customer_cover_information`
--
ALTER TABLE `customer_cover_information`
