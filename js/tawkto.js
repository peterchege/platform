(function (global) {
    global.$_Tawk_AccountKey = '5cc6aace4aa6620df2cfa5f1';
    ...
    (function (global) {
        global.$_Tawk.widgetSettings = {
            ...
            "bbl": {
                "name": "default",
                "type": "default",
                "txt": "Chat live with an agent now!",
                "bgc": "#041d38",
                "fgc": "#ffffff",
                "width": 105,
                "height": 80,
            ...
            "offlineForm": {
                ...
                "text": "All our agents are currently offline. Please fill out the form below and we will get back to you as soon as possible.",
                "fields": [{
                    "label": "Name",
                    "isRequired": true,
                    "type": "name"
            ...
            "prechatForm": {
                "text": "Please fill out the form below to start chatting with the next available agent.",
                "fields": [{
                    "label": "Name",
                    "isRequired": true,
                    "type": "name"
            ...
            "awayGreeting": {
                "shortMessage": "Away",
                "longMessage": "Be back in a while."
            },
            "cf": null,
            "emoji": true,
            "uploads": true,
    ...
    (function (u) {
        ...
        try {
            ...
            var t = {
                    ...
                    "message-preview-item": '<span class="message-preview-close-button icon-close"></span><div class="profileImageContainer"><div class="agentProfileImage"></div><div style="background-image : __IMAGE_URL__;" class="agentProfileImage"></div></div><div class="messageBody"><div class="message">__MESSAGE__</div><div class="messageNameContainer"><div class="messageName">__NAME__</div></div><div class="messageTimeContainer"><div class="messageTime">__TIME__</div></div></div>',
            ...
            wa.prototype.log = function (a, b) {
                var d;
                b && a && (b.uiVersion = "v3", b.buildVersion = "680", b.buildCommit = "e8cd920ca90ce70985198163e046a49b19073767", d = {
                    type: a,
                    data: b
            ...
            na.prototype.processSettings = function (a) {
                ...
                if (!(a.wv < f.widgetVersion)) {
                    ...
                    if (f.isEmbedded || f.isPopup) f.topCorner = 0, f.bottomCorner =
                        0;
            ...
            X.prototype.extractRegisterData = function (a) {
                a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/680/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
