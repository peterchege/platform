...
<head>
    ...
    <title>Life Claims -APA INSURANCE</title>
                ...
                <div class="row row-product">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="product-box we life-4">
                            <a href="claim_report_life_hosicash.php">
                    ...
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="product-box we life-5 ">
                            <a href="claim_report_life_lastexpense.php">
                                <div class="color-overlay"></div>
                                <div class="wrapper">
                                    <div class="content">
                    ...
                    <div class="row row-product">
                        ...
                        <div class="col-md-4 wow fadeInUp " data-wow-delay="0.4s">
                            <div class="product-box we img-death ">
                                <a href="claim_report_life_death.php">
                                    <div class="color-overlay"></div>
                                    <div class="wrapper">
                                        <div class="content">
                                            <h3>Death claims</h3>
                        ...
                        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="product-box we img-partial">
                                <a href="claim_report_life_partial_maturity.php" uk-toggle>
                                    <div class="color-overlay"></div>
                                    <div class="wrapper">
                                        <div class="content">
