...
<head>
    ...
    <title>Theft Cover - APA Insurance</title>
...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 com-6">
        </div>
    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <h2>Theft Cover</h2>
                                <P class="text-justify">Burglary or theft insurance policy provides indemnity against
                                    loss or damage of insured property resulting from theft accompanied by visible,
                                    forcible and violent entry into, or exit out of the insured premises.
                        ...
                        <div class="tab-pane fade" id="start" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="job-description text-left">
                                <br>
                                <p>If you are interested in learning how much Theft insurance would cost
                                    you to ensure business continuity, or if you are interested in purchasing Theft
                                    insurance, please click
                                    <b>Get Cover</b>.
                                </p>
                                <p>
                                    If you would like further explanation or assistance about how Theft insurance can
                                    make sure your business continues to run,
                                    please click <b>I Need Assistance</b>.
                                </p>
                                <!-- <p>
                                    <b> Download forms</b> will give you access to any relevant documents for Theft
                                    insurance,
