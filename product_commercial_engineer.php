...
<head>
    ...
    <title>Engineering Cover - APA Insurance</title>
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="job-description text-center">
                                ...
                                <div class="job-content">
                                    ...
                                    <div class="text-justify"><br>
                                        <ol>
                                            <li>CAR (Contractor's All Risks)</li><br>
                                            <li>Boiler And Pressure Vessel</li><br>
                                            <li>Erection All Risks</li><br>
                                            <li>Electronic Equipment Insurance</li><br>
                                            <li>Machinery Breakdown :<br>
                                                <p2>• Machinery Breakdown</p2><br>
                                                <p2>• Machinery Breakdown LOP</p2><br>
                                                <p2>• Deterioration Of Stock</p2><br>
                                            </li><br>
                        ...
                        <div class="tab-pane fade" id="start" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="job-description text-left">
                                <br>
                                <p>If you are interested in learning how much any of the Engineering insurance products
                                    would cost
