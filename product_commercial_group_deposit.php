...
<head>
    ...
    <title>Group Deposit Cover - APA Life</title>
...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 com-19">
        </div>
    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="start" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="job-description text-left">
                                <br>
                                <p>If you are interested in learning how much Group Deposit insurance would cost
                                    you, or if you are interested in purchasing Group Deposit insurance, please click
                                    <b>Get Cover</b>.
                                </p>
                                <p>
                                    If you would like further explanation or assistance about Group Deposit insurance,
    ...
    <!-- ===================================== LEAD FORM FOR group deposit ===================================== -->

    <div id="modal-full" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog">
            <button class="uk-modal-close-full uk-close-large" type="button" uk-close></button>
            <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-top" uk-grid>
                <div class="uk-background-cover uk-visible@m" style="background-image: url('img/deposit.jpg'); background-size: cover;" uk-height-viewport>
                </div>
