...
<head>
    ...
    <title>Apollo Money Market Fund - Apollo Asset Managment </title>
...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 asset-3b">
        </div>
    </div>
                            ...
                            <div class="job-description text-center">
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <p> CHARGES</p>
                                        <p2>There is no initial fee and an annual management fee of up to 2% is charged.
                                        </p2><br><br>
                                        <p2>Rate declared will be net of management fee charges. Withholding tax will
                                            apply.</p2><br><br><br>
                                        <p2><i>The price of shares, and the income therefrom is the collective
                                                investment scheme pays dividends,
                                                may go down as well as up: and investors are reminded that in certain
