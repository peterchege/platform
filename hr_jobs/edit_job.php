...
if(isset($_POST['submit_job_edit'])){
    $job_id = sanitize($_SESSION['editid']);
    ...
    if(empty($errors)){
         $updatequery = "UPDATE apa_job_posts SET job_title = '$job_title', job_short_description = '$job_short_description', country = '$country', 
                                county = '$county', company = '$company', employment_type = '$employment_type', salary = '$salary', key_primary_responsibilities = '$primary_responsibilities', 
                                academic_qualifications = '$academic_qualification', professional_qualifications = '$professional_qualifications', job_skills_and_requirements = '$job_skills', experience = '$experience', 
                                deadline = '$deadline', added_by = '$admin'  WHERE job_id = '$job_id' ";
        $db->query($updatequery);
        //unset($_SESSION['editid']);
        
        $_SESSION['successMessage']=$job_title.' updated successfully';
...
if(!isset($_GET['edit']) || isset($_POST['submit_job_edit'])){
    $_SESSION['errorMessage'] = 'Invalid selection.';
    echo "<script>
        window.open('index.php', '_SELF');
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-contact100">
                        <div class="wrap-contact100">
                            <form class="contact100-form validate-form" action="edit_job.php" method="POST">
                                <?php
                                if(!empty($errors)){
...
//                                echo successMessage();
                                ...
                                <?php while($e = mysqli_fetch_assoc($edit_query)): ?>

                                <?php $_SESSION['editid'] = sanitize($e['job_id']); ?>

                                <div class="wrap-input100 validate-input bg1" data-validate="Please Enter Job Name">
                                    <span class="label-input100">JOB TITLE *</span>
                                    <input class="input100" type="text" name="job_title" placeholder="Enter job name" value="<?= ((isset($e['job_title']))?$e['job_title']:''); ?>">
                                </div>
                                ...
                                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter employment type">
                                    ...
                                    <input class="input100" type="text" name="employment_type" placeholder="Enter type of employment " value="<?= ((isset($e['employment_type']))?$e['employment_type']:''); ?>">
                                </div>

                                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Country required">
                                    <span class="label-input100">Country*</span>
                                    <input class="input100" type="text" name="country" placeholder="Enter country" value="<?= ((isset($e['country']))?$e['country']:''); ?>">
                                </div>
                                ...
                                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="County required">
                                    ...
                                    <input class="input100" type="text" name="county" placeholder="Enter county" value="<?= ((isset($e['county']))?$e['county']:''); ?>">
                                </div>
                                ...
                                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter company">
                                    ...
                                    <input class="input100" type="text" name="company" placeholder="Enter company" value="<?= ((isset($e['company']))?$e['company']:''); ?>">
                                </div>

                                <div class="wrap-input100 rs1-wrap-input100">
                                    <span class="label-input100">Salary</span>
                                    <input class="input100" type="number" name="salary" placeholder="Enter salary" value="<?= ((isset($e['salary']))?$e['salary']:''); ?>">
                                </div>
                                ...
                                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter deadline">
                                    ...
                                    <input class="input100" type="date" name="deadline" value="<?= ((isset($e['deadline']))?$e['deadline']:''); ?>">
                                </div>
                                ...
                                <div class="wrap-input100 input100" data-validate="Short description required">
                                    ...
                                    <textarea id="editor0" class="input100" name="job_short_description" placeholder="Enter a short description of the job"><?=((isset($e['job_short_description']))?$e['job_short_description']:'');?></textarea>
                                </div>
                                ...
                                <div class="wrap-input100 input100" data-validate="Responsibilities required">
                                    ...
                                    <textarea id="editor1" class="input100" name="primary_responsibilities" placeholder="Enter key primary responsibilites of the applicant"><?=((isset($e['key_primary_responsibilities']))?$e['key_primary_responsibilities']:'');?></textarea>
                                </div>
                                ...
                                <div class="wrap-input100" data-validate="Academic qualifications required">
                                    ...
                                    <textarea id="editor2" class="input100" name="academic_qualification" placeholder="Academic qualifications"><?=((isset($e['academic_qualifications']))?$e['academic_qualifications']:'');?></textarea>
                                </div>
                                ...
                                <div class="wrap-input100" data-validate="Professional qualifications required">
                                    ...
                                    <textarea id="editor3" class="input100" name="professional_qualifications" placeholder="Professional qualifications"><?=((isset($e['professional_qualifications']))?$e['professional_qualifications']:'');?></textarea>
                                </div>

                                <div class="wrap-input100">
                                    <span class="label-input100">JOB SKILLS AND REQUIREMENTS</span>
                                    <textarea id="editor4" class="input100" name="job_skills" placeholder="Enter skills and requirements of the job"><?= ((isset($e['job_skills_and_requirements']))?$e['job_skills_and_requirements']:''); ?></textarea>
                                </div>

                                <div class="wrap-input100">
                                    <span class="label-input100">EXPERIENCE</span>
                                    <textarea id="editor5" class="input100" name="experience" placeholder="Enter experience of the applicant"><?= ((isset($e['experience']))?$e['experience']:''); ?></textarea>
                                </div>
                                <div class="container-contact100-form-btn">
                                    <button class="contact100-form-btn" type="submit" name="submit_job_edit">
                                        <span>
                                            Update
