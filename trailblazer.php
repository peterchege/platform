...
<head>
    ...
    <title>Trailblazzer - APA INSURANCE</title>
                ...
                <div class="col-md-6 col-lg-4 card-fin">
                    <div class="uk-card uk-card-default ">
                        <div class="uk-card-header">
                            <div class="uk-grid-small uk-flex-middle" uk-grid>
                                <div class="uk-width-auto">
                                    <img class="uk-border-circle1" width="100" height="50" src="img/doc/5.jpg">
                                </div>
                        ...
                        <div class="uk-card-footer">
                            <div class="row">
                                <div class="c0l-6">
                                    <a href="digital/trailblazer/may_2018_new" class="uk-button uk-button-text my-text" target="_blank">Read
                ...
                <div class="col-md-6 col-lg-4 card-fin">
                    <div class="uk-card uk-card-default ">
                        <div class="uk-card-header">
                            <div class="uk-grid-small uk-flex-middle" uk-grid>
                                <div class="uk-width-auto">
                                    <img class="uk-border-circle1" width="100" height="50" src="img/doc/4.jpg">
                                </div>
                                <div class="uk-width-expand">
