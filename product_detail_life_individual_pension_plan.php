...
<body>
    ...
    <div class="container-fluid212">
        <div class="header-image header-image1 life-7">
        </div>
    </div>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="job-description text-center">
                                ...
                                <P class="text-justify">We’ll help you think differently about retirement – more
                                    ...
                                    You may see yourself traveling, volunteering or simply spoiling your grand kids.
                                ...
                                <P class="text-justify">The plan allows you to first build your retirement income by
                                    ...
                                    retirement benefits in accordance with the option selected at the inception of the
                                    policy.
                                </P>
                                ...
                                <div class="job-content">
                                    <div class="text-justify">
                                        ...
                                        <p2>APA has averaged 10% net investment returns over the last 10 years. The
                                            ...
                                            a savings of Ksh 1,000 during a member's active work life of 35 years
                                        ...
                                        <table class="uk-table uk-table-hover uk-table-divider">
                                            <thead class="head-text">
                                                <tr>
                                                    ...
                                                    <th>Accumulated contribution at retirement </th>
                                        ...
                                        <p2>A professional independent corporate board of
                                            trustees ensures good governance in the management
                                            of the Scheme<br>
                                            Members’ interest is protected through compliance
                                            with all existing legislation with regards to the
                                            schemes.
                                        </p2>
    ...
    <div id="modal-close-outside" class="back-brochure" uk-modal>
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="row forms-download">
                ...
                <!-- Claim Form -->
                <div class="col-md-3 box-download">
                    <a href="pdf/proposal/IPP Proposal form.pdf" target="_blank">
                ...
                <!-- Claim Form -->
                <div class="col-md-3 box-download">
                    <a href="pdf/claim/IPP CLAIM FORM.pdf" target="_blank">
